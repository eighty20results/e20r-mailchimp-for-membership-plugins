...
if ( ! defined( 'PLUGIN_ABSPATH' ) ) {
	define( 'PLUGIN_ABSPATH', sys_get_temp_dir() . '/wp-content/plugins/ispcan-custom-functionality/' );
}

if ( ! defined( 'PLUGIN_PATH' ) ) {
	define( 'PLUGIN_PATH', __DIR__ . '/../ispcan-custom-functionality/' );
}
...
echo "Loading: " . __DIR__ . '/../../ispcan-custom-functionality.php';
require_once __DIR__ . '/../../ispcan-custom-functionality.php';